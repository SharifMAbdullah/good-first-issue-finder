/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d5de83c1138900def1d243276ed81e8e)
// Runtime types generated with workerd@1.20260317.1 2025-09-27 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		GITHUB_TOKEN: string;
		WORKER_SELF_REFERENCE: Fetcher /* good-first-issue-finder */;
	}
}
