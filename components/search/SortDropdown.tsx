...
export const SortDropdown = ({ value, onChange }: SortDropdownProps): React.ReactElement => {
  const [isOpen, setIsOpen] = useState(false);
  const dropdownRef = useRef<HTMLDivElement>(null);

  const selectedLabel = SORT_OPTIONS.find(opt => opt.value === value)?.label ?? 'Newest First';
